...
frame_processing_time_ms = Histogram("frame_processing_time_ms", "Average frame processing time", registry=registry)
...
boundingBoxFile = "./output/boundingBox.txt"
referenceFrame = 0
dilatedFrame = 0
...
#	print("app.debug =", app.debug, "env(WERKZEUG_RUN_MAIN) =", os.environ.get("WERKZEUG_RUN_MAIN"))
